...
" Setup mappings based on Lispyville
function! s:vim_sexp_mappings()
    ...
    nmap <silent><buffer> <LocalLeader>(  <Plug>(sexp_round_head_wrap_list)
    xmap <silent><buffer> <LocalLeader>(  <Plug>(sexp_round_head_wrap_list)
    nmap <silent><buffer> <LocalLeader>)  <Plug>(sexp_round_tail_wrap_list)
    xmap <silent><buffer> <LocalLeader>)  <Plug>(sexp_round_tail_wrap_list)
    ...
    nmap <silent><buffer> <M-(>           <Plug>(sexp_round_head_wrap_element)
    xmap <silent><buffer> <M-(>           <Plug>(sexp_round_head_wrap_element)
    nmap <silent><buffer> <M-)>           <Plug>(sexp_round_tail_wrap_element)
    xmap <silent><buffer> <M-)>           <Plug>(sexp_round_tail_wrap_element)
    nmap <silent><buffer> <M-[>           <Plug>(sexp_square_head_wrap_element)
    xmap <silent><buffer> <M-[>           <Plug>(sexp_square_head_wrap_element)
    nmap <silent><buffer> <M-]>           <Plug>(sexp_square_tail_wrap_element)
    xmap <silent><buffer> <M-]>           <Plug>(sexp_square_tail_wrap_element)
    nmap <silent><buffer> <M-{>           <Plug>(sexp_curly_head_wrap_element)
    xmap <silent><buffer> <M-{>           <Plug>(sexp_curly_head_wrap_element)
    nmap <silent><buffer> <M-}>           <Plug>(sexp_curly_tail_wrap_element)
    xmap <silent><buffer> <M-}>           <Plug>(sexp_curly_tail_wrap_element)
    nmap <silent><buffer> <M-I>           <Plug>(sexp_insert_at_list_head)
    nmap <silent><buffer> <M-A>           <Plug>(sexp_insert_at_list_tail)
    nmap <silent><buffer> <LocalLeader>@  <Plug>(sexp_splice_list)
    nmap <silent><buffer> <M-R>           <Plug>(sexp_raise_list)
    xmap <silent><buffer> <M-R>           <Plug>(sexp_raise_list)
    nmap <silent><buffer> <M-r>           <Plug>(sexp_raise_element)
    xmap <silent><buffer> <M-r>           <Plug>(sexp_raise_element)
    ...
    nmap <silent><buffer> <M-k>           <Plug>(sexp_swap_element_backward)
    xmap <silent><buffer> <M-k>           <Plug>(sexp_swap_element_backward)
    nmap <silent><buffer> <M-j>           <Plug>(sexp_swap_element_forward)
    xmap <silent><buffer> <M-j>           <Plug>(sexp_swap_element_forward)
