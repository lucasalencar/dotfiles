...
alias update_emacs="doom -y upgrade; doom -y refresh"

# Update every system that is interesting for the command line
alias update="update_dotfiles; upgrade_oh_my_zsh; update_brew; update_brew_cask; update_vim_plugins; update_emacs; update_tmux"
