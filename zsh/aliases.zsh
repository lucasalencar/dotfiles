...
alias update="brew update; brew upgrade --all; brew cleanup; gem update --system; vim +PlugUpdate +PlugClean! +qall"
...
alias dotfiles="cd $HOME/.dotfiles; vim $HOME/.dotfiles"
